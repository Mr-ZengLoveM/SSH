...
<html>
    ...
    <div class="x-body">
     ...
     <div class="layui-form-item">
              <label for="L_roomsid" class="layui-form-label">
                  <span class="x-red">*</span>房间ID
              </label>
              <div class="layui-input-inline">
                  <input type="text" id="L_roomsid" name="room.roomid" required="" lay-verify="roomsid"
                  autocomplete="off" class="layui-input layui-btn-disabled" disabled="disabled" value="${room.roomid}" />
              </div>
          </div>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${room.roomname}" />
              </div>
          </div>
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${room.roomdesc}" />
              </div>
          </div>
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${room.roomtype}" />
              </div>
          </div>
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${room.roomprice}" />
              </div>
          </div>
  ...
  */
          ...
          form.on('submit(add)', function(data){
            ...
            //发异步，把数据提交给action
  var  roomid = $('input[name="room.roomid"]').val();          
