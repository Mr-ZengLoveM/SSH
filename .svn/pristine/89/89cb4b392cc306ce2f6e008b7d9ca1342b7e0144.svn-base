 ...
 <span class="x-red">*</span>头像显示
  ...
  -->
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="password" id="L_repass" name="userr.userpasswd" required="" lay-verify="repass"
                  autocomplete="off" class="layui-input">
              </div>
          </div>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="L_username" name="userr.username" required="" lay-verify="userename" autocomplete="off" class="layui-input">
              </div>
          </div>
           <div class="layui-form-item">
        ...
        layui.use(['form','layer'], function(){
          ...
          form.on('submit(add)', function(data){
        	 ...
        	 // alert(usersex);
				$.ajax({
							type : 'POST',
							url : '<%=basePath%>/usersAction_addUsers',
							data : {
								'userr.userimg' : userimg
								,'userr.useremail' : useremail
								,'userspasswd' : userpasswd
							...
							success : function(data2) {
						          //alert(data2);
					            layer.alert("增加成功,请返回刷新查看", {icon: 6},function () {
					                // 获得frame索引
