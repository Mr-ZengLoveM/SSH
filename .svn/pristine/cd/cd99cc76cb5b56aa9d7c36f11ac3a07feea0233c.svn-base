	...
	<body>
		<div id="preview-container">
			...
			<div class="dvv2">
				...
				<hr style="color: darkgray;width: 900px;" class="hr1" />
				<div class="dvv3">
				...
				<ul class="u1">
					...
					<li>剧情介绍：${mov.mvintroduction}</li>
				</ul>
				<span class="sp1">上映时间：${mov.releasetime}</span>
			</div>
		</div>	
		<div style="width:1500px;margin: auto;">
		<iframe width=1500px height=330px frameborder=0 scrolling=auto src="./testOrders/add.jsp?mvid=${mov.mvid}"></iframe>
		</div>
	</body>
