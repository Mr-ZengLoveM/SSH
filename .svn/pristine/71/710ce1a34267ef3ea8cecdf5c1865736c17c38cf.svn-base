 ...
 <form class="layui-form">
           <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <div id="headimg" class="layui-upload-img"></div>
               
              </div>
          </div>

              <input type="hidden" name="movie.mvimg" id="imgsrc" required="" lay-verify="mvimg"
		...
		listKey="typeid" listValue="typename" value="%{#request.movie.types.typeid}"/>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="L_mvname" name="mv.mvname" lay-verify="mvname" autocomplete="off" class="layui-input">
              </div>
          </div>
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                    <input type="text" name="mv.releasetime" class="layui-input" id="L_mvreleasetime" placeholder="yyyy-MM-dd HH:mm:ss" lay-verify="mvreleasetime">
              </div>
          </div>          
           <div class="layui-form-item">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  lay-verify="mvintroduction"></textarea>
              </div>
          </div>
